...
Funkcija figura_moze_doci_do_polja kombinuje prva 2.
...
where T: Ima_podatke_o_tabli
{
    ...
    pub figura_moze_doci_do_polja: fn(tabla: &T, polje: u8, polje_na_kom_se_nalazim: u8, ja_sam_beli: bool) -> bool,
}
...
where T: Ima_podatke_o_tabli
{
    pub fn new(prirodno_kretanje: fn(
        ...
        figura_moze_doci_do_polja: fn(tabla: &T, polje: u8, polje_na_kom_se_nalazim: u8, ja_sam_beli: bool) -> bool,
    ) -> Figura_interfejs<T>{
        Figura_interfejs{prirodno_kretanje,  napada_polje, figura_moze_doci_do_polja}
    }
