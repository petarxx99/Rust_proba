...
mod top_test{
    ...
    fn testiraj_top_napada_belog_kralja<T>(tabla: &T, file_topa: u8, rank_topa: u8) -> bool 
    where T:Ima_podatke_o_tabli
    {
    ...
    fn top_sa_b4_ne_napada_kralja_na_g6(){
        ...
        assert_eq!(false, testiraj_top_napada_belog_kralja(&tabla, B_FILE, 4));
    }
